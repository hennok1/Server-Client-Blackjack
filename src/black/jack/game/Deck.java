...
/**
 *The Deck Object Class contains all 52 cards within a ArrayList and is shuffled
 * using the Collection.shuffle(); method. 
 * @author Hennok
 * @version 1.0
 */
public class Deck{
    ...
    /**
     *This variable indicates how many cards have been drawn from the deck.
     */
    public static int index=0;
    
    /**
     *Adds all 52 cards to a ArrayList that are in a standard Black Jack 
     *card deck and shuffles them.
     */
    public Deck(){
        ...
        cardList.add(new Card("Ace","Spades"));
        ...
        cardList.add(new Card("Ace","Diamonds"));
        ...
        cardList.add(new Card("Ace","Clubs"));
